...
# Set API base URL to use localhost (for internal service communication)
# This allows the Web app to connect to the API via localhost
ENV ApiBaseUrl=http://localhost:8080
ENV API_BASE_URL=http://localhost:8080
ENV ASPNETCORE_API_URL=http://localhost:8080
